...
public class LoginController{
	...
	public CommonResponse register(@RequestParam(value = "username") String code,
								   @RequestParam(value = "password") String pwd){
		System.out.println("...");
		String result = staffSV.register(code, pwd);
		if(result.equals("success")) {
		return new CommonResponse("1", "success");
		}
		else {
			throw new BaseAppException("SYS-LOGIN-0005", "注册失败");
		}
	}
